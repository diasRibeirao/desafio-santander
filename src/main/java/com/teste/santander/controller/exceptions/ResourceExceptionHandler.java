package com.teste.santander.controller.exceptions;
...
import com.teste.santander.service.exceptions.DataIntegrityException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> transacoes(TransacoesException e, HttpServletRequest request) {
		StandardError err = new StandardError(HttpStatus.NOT_FOUND.value(), e.getMessage(), System.currentTimeMillis());
		return ResponseEntity.status(HttpStatus.NOT_FOUND).body(err);
	}
